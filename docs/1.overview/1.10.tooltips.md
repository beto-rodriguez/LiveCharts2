...
![zooming](https://raw.githubusercontent.com/beto-rodriguez/LiveCharts2/master/docs/_assets/tooltip-custom-style.gif)
...
**CompareAll**: Selects one point per series, the closer point to the mouse position.

**CompareOnlyX**: Selects one point per series, the closer point to the mouse position, but it only measures the horizontal distance.

**CompareOnlyY**: Selects one point per series, the closer point to the mouse position, but it only measures the vertical distance.
