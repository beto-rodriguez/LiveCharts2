...
<div class="install">
    ...
    Package reference
    <button class="install-copy"><span></span> Copy</button>
    </div>
...
<p align="center">
  <img src="{{ assets_url }}/docs/_assets/firstchart.png" style="max-width: 600px;" />
</p>
...
```
.UseLiveCharts(config => config // mark
...
.UseLiveCharts(config => config // mark
    .AddLiveChartsAppSettings() // mark
    .AddLiveChartsRenderSettings()) // mark
```
