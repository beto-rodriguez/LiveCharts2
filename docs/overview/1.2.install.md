...
You can [get LiveCharts from NuGet](https://www.nuget.org/packages/LiveChartsCore.SkiaSharpView.{{ platform | to_platform_display_name }}).
...
<div class="install">
    ...
    <div class="install-body">
        &lt;PackageReference Include="LiveChartsCore.SkiaSharpView.{{ platform | to_platform_display_name }}" Version="{{ version }}" />
    </div>
</div>
...
<div class="install">
    ...
    <div class="install-body">
        dotnet add package LiveChartsCore.SkiaSharpView.{{ platform | to_platform_display_name }} --version {{ version }}
    </div>
</div>
...
<p align="center">
  <img src="{{ assets_url }}/docs/_assets/designer.gif" style="max-width: 900px" />
</p>
