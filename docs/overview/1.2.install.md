...
You can [get LiveCharts from NuGet](https://www.nuget.org/packages/LiveChartsCore.SkiaSharpView.{{ platform }}). If you need more help to 
...
<div class="install">
    <div class="install-header">Package reference</div>
    <div class="install-body">
        &lt;PackageReference Include="LiveChartsCore.SkiaSharpView.{{ platform }}" Version="{{ version }}" />
        <button class="install-copy"><span></span></button>
    </div>
</div>

<div class="install">
    <div class="install-header">dotnet CLI</div>
    <div class="install-body">
        dotnet add package LiveChartsCore.SkiaSharpView.{{ platform }} --version {{ version }}
        <button class="install-copy"><span></span></button>
    </div>
</div>
...
{{~ render_params_file_as_code this "~/../samples/MauiSample/MauiProgram.cs ~}}
...
{{~ render_params_file_as_code this "~/../samples/$PlatformSamplesFolder/General/FirstChart/$PlatformViewFile" ~}}
...
<p align="center">
  <img src="{{ assets_url }}/docs/_assets/firstchart.png" />
</p>
...
<p align="center">
  <img src="{{ assets_url }}/docs/_assets/designer-optimize.gif />
</p>

:::tip
XAML designer support is limited due SkiaSharp restriction to run in the designer (not in Avalonia), but 
...
```
{{ render this "~/../samples/UnoPlatformSample/UnoPlatformSample/App.xaml.cs" }}
```
{{~ end ~}}
...
method and chain the `AddLiveChartsAppSettings()` method.  
