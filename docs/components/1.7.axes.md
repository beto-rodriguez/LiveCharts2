...
Series = new ObservableCollection<ISeries>
{
    new LineSeries<double>
    {
        ...
        Fill = null,
        ScalesYAt = 0 // it will be scaled at the Axis[0] instance (see YAxes property bellow)
    },
    new LineSeries<double>
    {
        Name = "tens 2",
    ...
    new LineSeries<double>
    {
        ...
        Fill = null,
        ScalesYAt = 1 // it will be scaled at the YAxes[1] instance (see YAxes property bellow)
    },
    new LineSeries<double>
    {
        Name = "thousands",
        ...
        Fill = null,
        ScalesYAt = 2  // it will be scaled at the YAxes[2] instance (see YAxes property bellow)
    }
};
